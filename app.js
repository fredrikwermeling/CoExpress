...
`;
    ...
    showInlineCompareByTissue() {
        ...
        this._inlineCompareData = {
            title: `${gene} Expr — comparison of ${hotspotGene} ${mutLabel} vs WT, repeated within each ${groupLabel.toLowerCase()} subset`,
    ...
    showInlineCompareByHotspot() {
        ...
        this._inlineCompareData = {
            title: `${gene} Expr — comparison of ${mainHotspot} ${mutLabel} vs WT, repeated within each additional-${typeLabel.toLowerCase()} subset`,
    ...
    showInlineCompareByTranslocation() {
        ...
        this._inlineCompareData = {
            title: `${gene} Expr — comparison of ${mainHotspot} ${mutLabel} vs WT, repeated within each fusion subset`,
    ...
    _renderInlineCompareTable() {
        ...
        const subHeaders = [
            ...
            { label: 'Expr(WT)', sortIdx: 3 },
            { label: `N(${mutLabel || 'Mut'})`, sortIdx: 4 },
            { label: `Expr(${mutLabel || 'Mut'})`, sortIdx: 5 },
            { label: 'Δ Expr', sortIdx: 6 },
        ];
