...
`;
    ...
    renderGeneEffectByHotspot() {
        ...
        const layout = {
            annotations: [
                { text: `<b>${gene} Expression by Hotspot Mutation</b>`, xref: 'paper', yref: 'paper', x: 0.5, y: 1.02, xanchor: 'center', yanchor: 'bottom', showarrow: false, font: { size: 19 }, _tsRole: 'title' },
                { text: `${gene} Expression`, xref: 'paper', yref: 'paper', x: 0.5, y: -0.04, xanchor: 'center', yanchor: 'top', showarrow: false, font: { size: 17 }, _tsRole: 'xlabel' }
            ],
            xaxis: {
                zeroline: true,
    ...
    async downloadGeneEffectChartPNG() {
        ...
        const filename = `expression_${this.currentGeneEffect.gene}_by_${this.currentGEView}`;
    ...
    showCellLineDetail(cellLineId) {
        ...
        top += `<div class="clb-stat-row"><span class="clb-stat-label">Mean Expr</span><span class="clb-stat-value">${this.formatNum(mean)}</span></div>`;
