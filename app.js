        ...
        const traces = [
            {
                ...
                text: data.wt.map(d => `${d.cellName}<br>${d.lineage}<br>Expr: ${d.ge.toFixed(2)}`),
                hoverinfo: 'text'
            },
            {
                ...
                text: data.mut1.map(d => `${d.cellName}<br>${d.lineage}<br>Expr: ${d.ge.toFixed(2)}`),
                hoverinfo: 'text'
            },
            {
                ...
                text: data.mut2.map(d => `${d.cellName}<br>${d.lineage}<br>Expr: ${d.ge.toFixed(2)}`),
                hoverinfo: 'text'
            }
        ];
